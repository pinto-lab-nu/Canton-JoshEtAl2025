...
analysis_plotting_functions.plot_ecdf_comparison(r_matrix_df_real[1],r_matrix_df_pseudo[1],
                     label1='"MOs high trial count pseudo_data', label2="MOs high trial count data",
                     line_color1=params['general_params']['V1_cl'],line_color2=params['general_params']['M2_cl'],
                     xlabel="r values",
                     ylabel="proportion of iterations",
...
plot_comparison_boxplots_from_2d_dfs(r_matrix_df_real,r_matrix_df_pseudo)

plot_violin_comparison(r_matrix_df_real,r_matrix_df_pseudo)
# %%
